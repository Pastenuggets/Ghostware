...
local whitelisted = {
	...
	owners = {
		...
		"715f48021c34f09aba266e68b1a94c007d217ffe05aee2ce52d05e4e6847d2ac9927a471fc0940303aa78b8c02bab45b5383ed5ae030e296c8d4652e28ea3adc",
		"4973ea971c52bf34e8a2e28578f587926806a5c8f1752fdbc6c808720ff83f80f5ac28e027e240bc10a60aad41d7aeac711f0b677cb579c070829fbb5893319d",
...
lagbackevent.Event:connect(function(plr)
	if AutoToxic["Enabled"] then
		if AutoToxicLagback["Enabled"] then
			...
			local msg = custommsg or "Imagine lagbacking L "..(plr.DisplayName or plr.Name)..""
    ...
    if myTeam and myTeam.id == winstuff.winningTeamId and victorysaid == false then
		...
		if AutoToxic["Enabled"] then
			...
			if AutoToxicWin["Enabled"] then
				repstorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer(#AutoToxicPhrases["ObjectList"] > 0 and AutoToxicPhrases["ObjectList"][math.random(1, #AutoToxicPhrases["ObjectList"])] or "EZ L TRASH KIDS", "All")
			end
		end
    end
end)
