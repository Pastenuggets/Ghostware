local isDeobfuscated = "Yooo, you actually deobfuscated this lmfao. Well, props to you(unless you paid for it). Go on, leak it! I really don't care.(ignore this next line, that's for people who randomly printed this.)"
...
restorefunction(game.HttpService.JSONDecode)
restorefunction(game.Players.LocalPlayer.Kick)
restorefunction(game.RbxAnalyticsService.GetClientId)
restorefunction(tostring)
restorefunction(string.find)
...
elseif currentStatus[HWID] == "blacklisted" then
    ...
    runFunction(function()
        ...
        local anims = {
            ...
            ["PurpulV2"] = {
                {CFrame = CFrame.new(0.33, -0.45, 0.3) * CFrame.Angles(math.rad(-23), math.rad(50), math.rad(-90)), Time = 0.3},
                {CFrame = CFrame.new(0.33, -0.7, 0.6) * CFrame.Angles(math.rad(-25), math.rad(50), math.rad(-90)), Time = 0.3},
                {CFrame = CFrame.new(0.33, -0.7, 0.6) * CFrame.Angles(math.rad(-25), math.rad(50), math.rad(-90)), Time = 0.3},	
                {CFrame = CFrame.new(0.33, -0.45, 0.3) * CFrame.Angles(math.rad(-23), math.rad(50), math.rad(-90)), Time = 0.3}
        ...
        crit = Killaura.CreateToggle({
            ...
            Function = function(callback)
                if callback then 
                    ...
                    particle.RotSpeed = NumberRange.new(180)
                    particle.Enabled = true
                    particle.Size = NumberSequence.new(0.7)
                    particle.Texture = "rbxassetid://16801092660"  
        ...
        local damagemethods = {
            fireball = function(fireball, pos)
                ...
                if not (getPlacedBlock(pos - Vector3.new(0, 3, 0)) or getPlacedBlock(pos - Vector3.new(0, 6, 0))) then
                    ...
                    sound.SoundId = "rbxassetid://16913181866"
    ...
    runFunction(function()
        ...
        Wonder = function()
            task.spawn(function()
                ...
                local sky = Instance.new("Sky")
                sky.SkyboxBk = "rbxassetid://16136021536"
                sky.SkyboxDn = "rbxassetid://16136025360"
                sky.SkyboxFt = "rbxassetid://16136021536"
                sky.SkyboxLf = "rbxassetid://16136021536"
                sky.SkyboxRt = "rbxassetid://16136021536"
                sky.SkyboxUp = "rbxassetid://16136023362"
                sky.Parent = lightingService
                pcall(function() workspace.Clouds:Destroy() end)
                local damagetab = debug.getupvalue(bedwars.DamageIndicator, 2)
                damagetab.strokeThickness = false
                damagetab.textSize = 32
                damagetab.blowUpDuration = 0
                damagetab.baseColor = Color3.fromRGB(154, 27, 232)
                damagetab.blowUpSize = 32
                damagetab.blowUpCompleteDuration = 0
                damagetab.anchoredDuration = 0
                debug.setconstant(bedwars.DamageIndicator, 83, Enum.Font.LuckiestGuy)
                ...
                colorcorrection.Brightness = 0.05
                colorcorrection.Parent = lightingService
                debug.setconstant(require(lplr.PlayerScripts.TS.controllers.global.hotbar.ui.healthbar["hotbar-healthbar"]).HotbarHealthbar.render, 16, 12930502)
            end)
        end
    }
        ...
        GameThemeMode = GameTheme.CreateDropdown({
            Name = "Theme",
            Function = function() end,
            List = {"Old", "Winter", "Halloween", "Wonder", "Valentines"}
        })
    end)
    ...
    runFunction(function()
        ...
        local nobob = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "Bob",
            Function = function(callback) 
        ...
        local function PerformHighJump()
            ...
            if humanoidRootPart then
                ...
                for i = 1, 3 do  
                    ...
                    warningNotification("Wonder", "Currently " .. tostring(currentHeight) .. " studs in the air", 3)
                end
            end
        end

        TPHighJump = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "TPHighJump",
            Function = function(callback)
                if callback then
                    PerformHighJump()
    ...
    runFunction(function()
        ...
        TexturePack = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "FunnyPack",
            Function = function(callback)
                if callback then 
                    ...
                    local objs = game:GetObjects("rbxassetid://16563139729")
                    local import = objs[1]
                    ...
                    wait(1)
                    warningNotification("Wonder", "Packs in wonder only work after your sword changes(through death or buying a new one)", 5)
    ...
    runFunction(function()
        ...
        local selectedName = playerNameList[1]  -- braain = hurt after this one

        local function changePlayerNames()
            for _, player in ipairs(game.Players:GetPlayers()) do
                if player.Name == "aleenaswrldd" then
                    player.DisplayName = "AC MOD (Aleena)"
                elseif player.Name == "SaviGamesOnline" then
                    player.DisplayName = "AC MOD (Savi 💖)"
                else
                    player.DisplayName = selectedName
                end
        ...
        local function resetPlayerNames()
            for _, player in ipairs(game.Players:GetPlayers()) do
                player.DisplayName = player.Name
            end
        end

        NameHider = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "NameHider",
            Function = function(enabled)
                NameHider.Enabled = enabled
                if enabled then
                    changePlayerNames()
                else
                    resetPlayerNames()
        ...
        NameHider.CreateDropdown({
            ...
            HoverText = "NameHider - Made By Star"
        })
    end)
    ...
    runFunction(function()
        ...
        local FastFlyVerticalSpeed = {Value = 100}
        ...
        local Damageplayer = {Enabled = false}
        local FlyAnywayProgressBarFrame
        local olddeflate
        ...
        FastFly = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "DamageFly",
            Function = function(callback)
                if callback then
                    if Damageplayer.Enabled and entityLibrary.isAlive then
                        warningNotification("Wonder", "for 0.2 second", 0.2)
                        
                        game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(CFrame.new(game.Players.LocalPlayer.Character.PrimaryPart.Position - Vector3.new(0, 8, 0)))
                        task.wait(0.2)
                        game.Players.LocalPlayer.Character:SetPrimaryPartCFrame(CFrame.new(game.Players.LocalPlayer.Character.PrimaryPart.Position + Vector3.new(0, 9, 0)))
                    end
                    task.wait(0.1)
                    olddeflate = bedwars.BalloonController.deflateBalloon
                    bedwars.BalloonController.deflateBalloon = function() end
    ...
    wait(0.5)
            ...
            HoverText = "Fast fly (really ment for zephyr and/or scythe disabler) improve by @murderplots aka N0tMe",
            ExtraText = function() 
                return "zoommmmm"
            end
        })
        ...
        Damageplayer = FastFly.CreateToggle({
            Name = "Damage",
            Function = function() end,
            Default = false
        })
    ...
    runFunction(function()
        ...
        local CapeW = {Enabled = false}
        local CapeBS = {Enabled = false}

        CapeW = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "WonderCape",
            Function = function(callback)
                if callback then
                    if CapeBS.Enabled then CapeBS.ToggleButton(false) end
                    local successfulcustom = false --don't feel like editing allat
                    table.insert(CapeW.Connections, lplr.CharacterAdded:Connect(function(char)
                        task.spawn(function()
                            pcall(function() 
                                capeFunction(char, (successfulcustom or downloadVapeAsset("vape/assets/WonderCape.png")))
                            end)
                        end)
                    end))
                    if lplr.Character then
                        task.spawn(function()
                            pcall(function() 
                                capeFunction(lplr.Character, (successfulcustom or downloadVapeAsset("vape/assets/WonderCape.png")))
                            end)
                        end)
                    end
                else
        ...
        CapeBS = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "BedwarsStoreCape",
            Function = function(callback)
                if callback then
                    if CapeW.Enabled then CapeW.ToggleButton(false) end
                    local successfulcustom = false --don't feel like editing allat
                    table.insert(CapeBS.Connections, lplr.CharacterAdded:Connect(function(char)
                        task.spawn(function()
                            pcall(function() 
                                capeFunction(char, (successfulcustom or downloadVapeAsset("vape/assets/BedwarsStoreCape.png")))
                            end)
                        end)
                    end))
                    if lplr.Character then
                        task.spawn(function()
                            pcall(function() 
                                capeFunction(lplr.Character, (successfulcustom or downloadVapeAsset("vape/assets/BedwarsStoreCape.png")))
                            end)
                        end)
                    end
                else
    ...
    runFunction(function()
        ...
        insta = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "InfernoInstakill",
            Function = function(callback)
                if callback then
                    task.spawn(function()
                        repeat
    ...
    runFunction(function()
        local Children = {Enabled = false, FullMode = false}
        local Startupdtv

        local function Stopupdtv()
            if Startupdtv then
                Startupdtv:Disconnect()
                Startupdtv = nil
            end
        end

        local function Startupdtv()
            Stopupdtv()

            Startupdtv = game:GetService("RunService").Heartbeat:Connect(function()
                if Children.FullMode then
                    bedwarsStore.FunnySpeedTick = tick() + 1
                    local argsNegative = {
                        [1] = {
                    ...
                    game:GetService("ReplicatedStorage"):WaitForChild("rbxts_include"):WaitForChild("node_modules"):WaitForChild("@rbxts"):WaitForChild("net"):WaitForChild("out"):WaitForChild("_NetManaged"):WaitForChild("RocketImpulse"):InvokeServer(unpack(argsNegative))
                    game:GetService("ReplicatedStorage"):WaitForChild("rbxts_include"):WaitForChild("node_modules"):WaitForChild("@rbxts"):WaitForChild("net"):WaitForChild("out"):WaitForChild("_NetManaged"):WaitForChild("RocketImpulse"):InvokeServer(unpack(argsPositive))
                else
                    local player = game.Players.LocalPlayer
                    local humanoid = player.Character and player.Character:FindFirstChildOfClass("Humanoid")
                    local function getCurrentVelocity()
                        if humanoid and humanoid.RootPart then
                            return humanoid.RootPart.Velocity
                        else
                            return Vector3.new(0, 0, 0)
                        end
                    end

                    local currentVelocity = getCurrentVelocity()
                    local args = {
                        [1] = {
        ...
        Children = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "ChildLoverExploitV2",
            Function = function(callback)
                Children.Enabled = callback
                if callback then
                    wait(0.5)
                    warningNotification("Wonder", "Funnying #1", 2)
                    wait(0.7)
                    warningNotification("Wonder", "Funnying #2", 2)
                    wait(0.8)
                    warningNotification("Wonder", "Wonder Airlines ™️", 2)
            ...
            HoverText = "floatcheck moment (found by star hehe)"
        })
        Children.CreateToggle({
            Name = "Full",
            Function = function(state)
                Children.FullMode = state
                if Children.Enabled then
                    Startupdtv() 
                end
            end
        })
    ...
    runFunction(function()
        ...
        local function tweenToNearestPlayer()
            ...
            if nearestPlayer and not tped then
                ...
                warningNotification("Wonder", "Teleporting to " .. playerName, 5)  
                ...
                if not teleportSuccess and isPlayerAlive(nearestPlayer) then
                    warningNotification("Wonder", "Teleport failed", 5) 
                end
            end
        end
    
        PlayerTP = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "PlayerTP",
            Function = function(callback)
                if callback then
    ...
    runFunction(function()
        ...
        local ACModDetector = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "ACModDetector",
            Function = function(enabled)
    ...
    runFunction(function()
        local DirectionalClipEnabled = false
        local forwardDistance = 0
        local backwardDistance = 0
        local leftDistance = 0
        local rightDistance = 0
        local upwardDistance = 0
        local downwardDistance = 0
        local player = game.Players.LocalPlayer

        local DirectionalClip = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "Directional Clip",
            Function = function(enabled)
                DirectionalClipEnabled = enabled
                if enabled then
                    
                    local rootPart = player.Character.HumanoidRootPart
                    local cframe = rootPart.CFrame
                    local newPosition = cframe.Position + (cframe.LookVector * (forwardDistance - backwardDistance)) + (cframe.RightVector * (rightDistance - leftDistance)) + Vector3.new(0, upwardDistance - downwardDistance, 0)
                    
                    rootPart.CFrame = CFrame.new(newPosition)
                    DirectionalClip.ToggleButton(false)  
                end
            end,
            HoverText = "Teleports the player in the specified direction."
        })

        DirectionalClip.CreateSlider({
            Name = "Forward",
            Min = 0,
            Max = 10,
            Function = function(value)
            ...
            HoverText = "Distance to teleport forward."
        })
        ...
        DirectionalClip.CreateSlider({
            ...
            HoverText = "Distance to teleport backward."
        })
        ...
        DirectionalClip.CreateSlider({
            ...
            HoverText = "Distance to teleport to the left."
        })
        ...
        DirectionalClip.CreateSlider({
            ...
            HoverText = "Distance to teleport to the right."
        })
        ...
        DirectionalClip.CreateSlider({
            ...
            Max = 10,
            Function = function(value)
                upwardDistance = value
            end,
            HoverText = "Distance to teleport upward."
        })
        ...
        DirectionalClip.CreateSlider({
            ...
            HoverText = "Distance to teleport downward."
        })
    end)
    ...
    runFunction(function()
        ...
        local UsernamesCheckEnabled = false
        local InfiniteFlyEnabled = false
        local InfiniteFlyAltitudeThreshold = 150  

        local lplr = game.Players.LocalPlayer
        local suspiciousNames = {
            "vxpe", "vxepe", "v4", "config", "ware", "snoopy", "0prime", "skid",
            "vega", "krampus", "roexc", "ro_exc"  -- may not be working cuz im slow
        }

        local function checkPlayerUsernames()
            while UsernamesCheckEnabled do
                for _, player in ipairs(game.Players:GetPlayers()) do
                    for _, susName in ipairs(suspiciousNames) do
                        if string.find(string.lower(player.Name), string.lower(susName)) then
                            warningNotification("HackerDetector", "User: " .. player.Name .. ", sus name", 5)
                            break
                        end
                    end
                end
        ...
        local function checkPlayerAltitudes()
            while InfiniteFlyEnabled do
                for _, player in ipairs(game.Players:GetPlayers()) do
                    if player ~= lplr and player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                        local altitude = player.Character.HumanoidRootPart.Position.Y
                        if altitude > InfiniteFlyAltitudeThreshold then
                            warningNotification("HackerDetector", player.Name .. " is " .. math.floor(altitude) .. " meters in the air, Inf Fly", 5)
                        end
                    end
                end
                wait(1)
        ...
        local HackerDetector = GuiLibrary.ObjectsThatCanBeSaved.WonderWindow.Api.CreateOptionsButton({
            Name = "HackerDetector",
            Function = function(enabled)
                HackerDetectorEnabled = enabled
                UsernamesCheckEnabled = enabled and UsernamesCheckEnabled
                InfiniteFlyEnabled = enabled and InfiniteFlyEnabled
            end,
            HoverText = "Detects potential hacking behaviors."
        })

        HackerDetector.CreateToggle({
            Name = "Usernames",
            Function = function(enabled)
                UsernamesCheckEnabled = enabled and HackerDetectorEnabled
                if enabled then
                    checkPlayerUsernames()
                end
            end,
            HoverText = "not 100% sure its working."
        })

        HackerDetector.CreateToggle({
            Name = "InfiniteFly",
            Function = function(enabled)
                InfiniteFlyEnabled = enabled and HackerDetectorEnabled
                if enabled then
                    checkPlayerAltitudes()
                end
            end,
            HoverText = "yes"
        })

        HackerDetector.CreateSlider({
            Name = "InfFlyHeightDetection",
            Min = 1,
            Max = 500,
            Default = 150,
            Function = function(value)
                InfiniteFlyAltitudeThreshold = value
            end,
            HoverText = "minimum height for detecting InfiniteFly."
        })
    end)
    ...
    runFunction(function()
        ...
        overlayframe.BackgroundColor3 = Color3.fromRGB(99, 95, 98)
        ...
        overlayframe3.BackgroundColor3 = Color3.fromRGB(99, 95, 98)
        ...
        framecorner1.CornerRadius = UDim.new(0, 8)
        ...
        label.BackgroundColor3 = Color3.fromRGB(99, 95, 98)
        label.TextSize = 16
        label.Text = ""
