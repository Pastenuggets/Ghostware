...
vapeoptionsbutton.MouseButton1Click:connect(function()
	...
	writefile("vape/OldProfiles/friends.vapefriends", game:GetService("HttpService"):JSONEncode(api["FriendsObject"]["Friends"]))
api["SaveFriends"] = function()
end

api["LoadFriends"] = function()
	local success, result = pcall(function()
		return game:GetService("HttpService"):JSONDecode(readfile("vape/OldProfiles/friends.vapefriends"))
	end)
...
api["SaveSettings"] = function()
	...
	writefile("vape/OldProfiles/"..game.PlaceId..".vapeprofilez", game:GetService("HttpService"):JSONEncode(api["Settings"]))
end

api["LoadSettings"] = function()
	local success, result = pcall(function()
		return game:GetService("HttpService"):JSONDecode(readfile("vape/OldProfiles/"..game.PlaceId..".vapeprofilez"))
	end)
	if success and type(result) == "table" then
