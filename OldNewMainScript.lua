...
local GuiLibrary = loadstring(GetURL("OldNewGuiLibrary.lua"))()
...
if isfolder("vape/OldCustomModules") == false then
	makefolder("vape/OldCustomModules")
end
if isfolder("vape/OldProfiles") == false then
	makefolder("vape/OldProfiles")
end
